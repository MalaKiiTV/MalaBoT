...
class Moderation(commands.Cog):
    ...
    @app_commands.command(name="delete", description="Message deletion commands (Mod only)")
    ...
    @app_commands.command(name="kick", description="Kick a user from the server (Mod only)")
    @app_commands.default_permissions(administrator=True)
    ...
    @app_commands.command(name="ban", description="Ban a user from the server (Mod only)")
    @app_commands.default_permissions(administrator=True)
    ...
    @app_commands.command(name="mute", description="Mute a user in the server (Mod only)")
    @app_commands.default_permissions(administrator=True)
    ...
    @app_commands.command(name="unmute", description="Unmute a user in the server (Mod only)")
    @app_commands.default_permissions(administrator=True)
