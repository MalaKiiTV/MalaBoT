...
class Moderation(commands.Cog):
    ...
    async def delete(self, interaction: discord.Interaction, action: str):
        ...
        try:
            ...
            if not (is_bot_owner or has_admin_perm):
                embed = embed_helper.error_embed(
                    ...
                    description=f"This command is only available to:\n\n"
                               ...
                               f"• Manage Server: {'✅' if interaction.user.guild_permissions.manage_guild else '❌'}"
                )
                await interaction.response.send_message(embed=embed, ephemeral=True)
            ...
            if not (is_bot_owner or has_admin_perm):
                embed = embed_helper.error_embed(
                    ...
                    description=f"This command is only available to:\n\n"
                               f"• Bot Owners\n"
                               f"• Server Administrators\n"
                               f"• Users with Kick Members permission\n\n"
                               f"Your current permissions:\n"
                               f"• Bot Owner: {'✅' if is_bot_owner else '❌'}\n"
                               f"• Administrator: {'✅' if interaction.user.guild_permissions.administrator else '❌'}\n"
                               f"• Kick Members: {'✅' if interaction.user.guild_permissions.kick_members else '❌'}"
                )
                await interaction.response.send_message(embed=embed, ephemeral=True)
            ...
            if not (is_bot_owner or has_admin_perm):
                embed = embed_helper.error_embed(
                    ...
                    description=f"This command is only available to:\n\n"
                               f"• Bot Owners\n"
                               f"• Server Administrators\n"
                               f"• Users with Ban Members permission\n\n"
                               f"Your current permissions:\n"
                               f"• Bot Owner: {'✅' if is_bot_owner else '❌'}\n"
                               f"• Administrator: {'✅' if interaction.user.guild_permissions.administrator else '❌'}\n"
                               f"• Ban Members: {'✅' if interaction.user.guild_permissions.ban_members else '❌'}"
                )
                await interaction.response.send_message(embed=embed, ephemeral=True)
            ...
            if not (is_bot_owner or has_admin_perm):
                embed = embed_helper.error_embed(
                    ...
                    description=f"This command is only available to:\n\n"
                               f"• Bot Owners\n"
                               f"• Server Administrators\n"
                               f"• Users with Moderate Members permission\n\n"
                               f"Your current permissions:\n"
                               f"• Bot Owner: {'✅' if is_bot_owner else '❌'}\n"
                               f"• Administrator: {'✅' if interaction.user.guild_permissions.administrator else '❌'}\n"
                               f"• Moderate Members: {'✅' if interaction.user.guild_permissions.moderate_members else '❌'}"
                )
                await interaction.response.send_message(embed=embed, ephemeral=True)
