...
class Moderation(commands.Cog):
    ...
    @app_commands.command(name="delete", description="Message deletion commands (Server Owner only)")
    ...
    @app_commands.command(name="kick", description="Kick a user from the server (Server Owner only)")
    @app_commands.default_permissions(administrator=True)
    ...
    @app_commands.command(name="mute", description="Mute a user in the server (Server Owner only)")
    @app_commands.default_permissions(administrator=True)
    ...
    @app_commands.command(name="unmute", description="Unmute a user in the server (Server Owner only)")
    @app_commands.default_permissions(administrator=True)
